...
const ResponsiveDrawer = (props) => {
        ...
        <a href={`/manage/course/${props.match.params.courseId}/subjects`} style={{textDecoration: 'none'}}>
          ...
          <li class="nav-item active">
            <ListItem Button >
              ...
              <ListItemText style={{color: purple[500]}} primary="Create Subject"/>
            </ListItem>
          </li>
        <li class="nav-item">
  ...
  const ManageSubject = () => {
    ...
    const { sname, sphoto, sphoto_status, error, success, loading, formData} = subjects;
    ...
    const onSubmit =  event => {
      ...
      // Backend request
      createPushSubjectToCourse(user._id, token, props.match.params.courseId, formData)
      .then(data => {
        if (data.error) {
          ...
          <div className="row pt-3 pb-3" >
            <div className="col-md-6 offset-sm-3 text-left">
              <div className="alert alert-success shadow"  style={{ borderRadius: 30}}>
                <center> <h4 className="text-success my-auto">Subject Created Succesfully in {name}</h4>
                <h6 className=" pt-1 my-auto">Go to <a href={`/manage/course/${props.match.params.courseId}/subjects`} style={{textDecoration: "none"}}>subjects </a>to get the update</h6>
                  </center>
              </div>
            </div>
          </div>  
            ...
            <Grid container spacing="4">
              ...
              <Grid item xs={12} sm={12} md={12} >
                  ...
                  <CardContent>
                      ...
                      <h5 className="font-weight-bold pb-2 pt-1" style={{color: "#019031"}}>Create Subject</h5>
                      </Typography>
