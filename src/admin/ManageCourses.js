...
import {getAllCourse, deleteCourse} from "./helper/adminapicall";
        ...
        <li class="nav-item active">
            <a href="/manage/course/create" style={{textDecoration: 'none'}}>
              <ListItem Button >
                ...
                <ListItemText style={{color: green[800]}} primary="Create Course"/>
              </ListItem>
            </a>
          </li>
        <li class="nav-item">
                ...
                <Grid container spacing="2">
                        ...
                        <div className="row">
                          ...
                          <Grid item xs={12} sm={6} md={8} >
                            <div className=" m-1 d-block w-100 h-100">
                              ...
                              <Link to={`/manage/course/${course._id}/subjects`}>
                                  <button className="btn pl-2 shadow text-white"  style={{ borderRadius: 5,
                                    backgroundColor: '#1976d2'}}>
                                      <center>Manage Subjects</center>
                                  </button>
                              </Link>
                              <p className="mt-2" style={{fontSize: 20,fontWeight: "bold", color: "red"}}>Price: Rs. {course.amount}</p>
                  ...
                  <Grid item xs={12} sm={12} md={12}>
                    <Grid item xs={12} sm={12} md={6}>
                      <Link to={`/manage/course/update/${course._id}`}>
                          ...
                          <button onClick={() => {
                             confirmAlert({
                              ...
                              buttons: [
                                {
                                  label: 'Yes',
                                  onClick: () => deleteThisCourse(course._id)
                                },
                                {
                                  label: 'No',
                                  onClick: () => {}
                            ...
                            }} className="btn btn-danger" style={{ borderRadius: 5}}>
