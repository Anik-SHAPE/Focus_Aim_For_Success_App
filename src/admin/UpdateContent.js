...
import {getCourse, createPushSubjectToCourse, getAllSubjectByCourse, deleteSubject, getSubject, getQuestion, updateSubjectupdateQuestion, updateQuestion, getChapter} from "./helper/adminapicall";
            ...
            <div className="row pt-3 pb-3" >
              <div className="col-md-6 offset-sm-3 text-left">
                <div className="alert alert-success shadow"  style={{ borderRadius: 30}}>
                  ...
                  <h6 className=" pt-1 my-auto">Go to <a href={`/manage/${props.match.params.subjectId}//${props.match.params.chapterId}/contents`} style={{textDecoration: "none"}}>Contents </a>to get the update</h6>
                    </center>
                </div>
              </div>
            </div>  
