...
import {getCourse, getAllSubjectByCourse, deleteSubject} from "../admin/helper/adminapicall";
    ...
    <div>
     ...
     <center><img class="pb-5" src={Logo} width="140" height="190"/></center>
      ...
      <list>
        ...
        <li class="nav-item">
          <a href="/user/dashboard/courses" style={{textDecoration: 'none'}}>
            <ListItem Button>
              <ListItemIcon>
      ...
      <div className={classes.root}>
        ...
        <AppBar style={{backgroundColor: '#0C090A', borderBottomLeftRadius: 15, borderBottomRightRadius: 15}} position="fixed" className={classes.appBar}>
            ...
            <Typography variant="h6" noWrap >
              <h5 style={{color: "#ba68c8"}}>{name}</h5> <h6 class="my-auto font-weight-bolder">( Subject's )</h6>
            </Typography>
            </Toolbar>
        </AppBar>
        ...
        <main className={classes.content}>
          <div className={classes.toolbar} />
            ...
            {getsubjects.map((subject, index) => { 
              return (
                  <div key={index} className="col-12 col-md-3 mb-3">
                    <Card  className="shadow-lg" style={{ backgroundColor: "#512da8", borderRadius: 15}}>
                      <Link to={`/courses/${props.match.params.courseId}/${subject._id}/chapters`} style={{textDecoration: "none"}}>
                        <ImageFetcher subject={subject}/>   
                        <center><h5 className="pt-2 pl-2 pr-1 pb-1" style={{color: "#ffffff"}}>{subject.sname}</h5></center>
                      </Link>
                    </Card>
                  </div>
              )  
            ...
            {getsubjects.map((subject, index) => { 
              return (
                <Link key={index} to={`/courses/${props.match.params.courseId}/${subject._id}/chapters`} style={{textDecoration: "none"}}>

                
                <Card className="d-block w-100 mb-3" style={{height: 70, borderRadius: 10, backgroundColor: "#ffffff"}}>
                  <div className="row ml-2 mr-2">
                    <Card  className="shadow mt-2" style={{ backgroundColor: "#ffffff", borderRadius: 100, width: 50, height: 50}}>
                      <ImageFetcher className="d-block w-100 h-100" subject={subject}/>  
                    </Card> 
                    <h5 className="pl-2 my-auto pt-2" style={{color: "#000000"}}>{subject.sname}</h5>
                  </div>
                </Card>
                </Link>
