...
const ManageContent = (props) => {
  ...
  const drawer = ( 
    <div>
     ...
     <center><img class="pb-5" src={Logo} width="140" height="190"/></center>
      ...
      <list>
      <ul class="navbar-nav">
      <a href={`/courses/${props.match.params.subjectId}/${props.match.params.chapterId}/chapter/introduction`} style={{textDecoration: 'none'}}>
          ...
          <li class="nav-item active">
            <ListItem Button >
              ...
              <ListItemText style={{color: purple[500]}} primary="MCQ's"/>
            </ListItem>
          </li>
          </a>
  ...
  const GetContent = () => {
    ...
    const toggle = questionId => {
      if(user._id, token, props.match.params.chapterId, questionId){
        setIsOpen(!isOpen);
      }
    }
      ...
      <div className={classes.root}>
        ...
        <AppBar style={{backgroundColor: '#0C090A',borderBottomLeftRadius: 15, borderBottomRightRadius: 15}} position="fixed" className={classes.appBar}>
            ...
            <Typography variant="h6" noWrap >
              <h5 style={{color: "#ba68c8"}}>{cname}</h5> <h6 class="my-auto font-weight-bolder">( Content's )</h6>
            </Typography>
            </Toolbar>
        </AppBar>
                        ...
                        <div className="row">
                          ...
                          <Grid item xs={11} sm={12} md={12} >
                            <div className=" mt-2 ml-3 d-block w-100 h-100">
                              ...
                              <Button color="primary" className="pl-3" onClick={() => toggle(question._id)} style={{ marginBottom: '1rem', outline: "none" }}>View Answer </Button>
