...
import {getSubject, createPushChapterToSubject} from "../admin/helper/adminapicall";
...
const Chapter = (props) => {
  ...
  const drawer = ( 
    <div>
     ...
     <center><img class="pb-5" src={Logo} width="140" height="190"/></center>
      ...
      <list>
        <ul class="navbar-nav">
        <a href={`/manage/writter/${props.match.params.courseId}/${props.match.params.subjectId}/chapters`} style={{textDecoration: 'none'}}>
        <li class="nav-item active">
          ...
          <li class="nav-item active">
            <ListItem Button >
              ...
              <ListItemText style={{color: purple[500]}} primary="Create Chapter"/>
            </ListItem>
          </li>
        <li class="nav-item">
  ...
  //Backend chapter create request
  ...
  const CreateChapter = () => {
    ...
    const {cname, introduction, success, videoLinkOne, videoLinkTwo, videoLinkThree, videoLinkFour, videoLinkFive, error, loading} = chapter;
    ...
    const onSubmit = event => {
        ...
        // Backend request to create chapter
        createPushChapterToSubject(user._id, token, props.match.params.subjectId, {cname, introduction, videoLinkOne, videoLinkTwo, videoLinkThree, videoLinkFour, videoLinkFive})
        .then(data => {
            if(data.error){
            ...
            <div className="row pt-3 pb-3" >
              <div className="col-md-6 offset-sm-3 text-left">
                <div className="alert alert-success shadow"  style={{ borderRadius: 30}}>
                  <center> <h4 className="text-success my-auto">Chapter Created Succesfully in {sname}</h4>
                  <h6 className=" pt-1 my-auto">Go to <a href={`/manage/writter/${props.match.params.courseId}/${props.match.params.subjectId}/chapters`} style={{textDecoration: "none"}}>Chapters </a>to get the update</h6>
                    </center>
                </div>
              </div>
            </div>  
                  ...
                  <form>
                    ...
                    <div className="form-group">
                      <TextField fullWidth style={{backgroundColor: "#ffffff", borderRadius: 5}}
                                id="introduction" placeholder="Write your chapter introduction here." 
