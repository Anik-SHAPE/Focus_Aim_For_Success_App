...
import {getChapter} from "../admin/helper/adminapicall";
      ...
      <div className={classes.root}>
        ...
        <main className={classes.content}>
          ...
          <Grid container spacing="2">
            ...
            <Card className={classes.root}  className={classes.card} className="shadow-lg" style={{ borderRadius: 10, backgroundColor: "#ffffff"}}>
            <center><h1 className="m-5" style={{color: "#d500f9"}}>{cname}</h1></center><br/>
            <h4 className="ml-3 mr-3 mb-3 text-justify" style={{whiteSpace: "pre-line", wordWrap: "break-word"}}>{introduction}</h4>
            </Card>
            </Grid>
        </Grid>
        </main>
